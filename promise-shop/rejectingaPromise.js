// From https://github.com/stevekane/promise-it-wont-hurt
...
let onReject = function onReject(error) {
    console.log(error.message);
}

let onFufill = function onFufill(message) {
    console.log(message);
}

// Calling the promise
promise.then(onFufill, onReject);